...
public class Program {
	...
	public static void main(String[] args) {
		...
		double porcentagemPessoaMenorIdade = quantidadeMenorIdade * 100.0 / vect.length;
		System.out.printf("Pessoa com menos de 16 anos: %.1f%%%n", porcentagemPessoaMenorIdade);
